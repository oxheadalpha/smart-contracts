...
{}
{ 
  Elt 0 (Pair 0 ${token_meta_literal('RED', 'RAINBOW_TOKEN')}) ;
  Elt 1 (Pair 1 ${token_meta_literal( 'ORANGE', 'RAINBOW_TOKEN')}) ;
  Elt 2 (Pair 2 ${token_meta_literal('YELLOW', 'RAINBOW_TOKEN')}) ;
  Elt 3 (Pair 3 ${token_meta_literal('GREEN', 'RAINBOW_TOKEN')}) ;
  Elt 4 (Pair 4 ${token_meta_literal('BLUE', 'RAINBOW_TOKEN')}) ;
  Elt 5 (Pair 5 ${token_meta_literal('INDIGO', 'RAINBOW_TOKEN')}) ;
  Elt 6 (Pair 6 ${token_meta_literal('VIOLET', 'RAINBOW_TOKEN')})
}
(Right (Right Unit))
(Right (Left Unit))
(Right (Left Unit))
None)
(Pair "${owner}" None False)
